...
function MessageScrollerViewport({
  ...
  return (
    <MessageScrollerPrimitive.Viewport
      ...
      className={cn(
        "size-full min-h-0 min-w-0 scroll-fade scrollbar-gutter-stable overflow-y-auto overscroll-contain contain-content data-autoscrolling:scrollbar-track-transparent",
        className
      )}
      {...props}
    />
